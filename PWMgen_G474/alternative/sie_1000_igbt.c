...
void modulation_acc (float a){
	ratio = min(max(7.271428 * a, 3.635714 * basfrq), 502);
	AMP = min(max(a * 0.018859, basfrq * 0.009429), 1);
	OFFSET = min(max(0.5 - a * 0.009429, 0), 0.5 - basfrq * 0.0047145);
}
void modulation_dec (float a){
	ratio = min(max(a * 6.3625, 3.635714 * basfrq), 502);
	AMP = min(max(a * 0.015792, basfrq * 0.009429), 1);
	OFFSET = min(max(0.5 - a * 0.0078955, 0), 0.5 - basfrq * 0.0047145);
}
void shell_sort (void){
